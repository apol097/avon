    ...
    <div class= "body" style="background-image: url('../img/belleza.jpg'); background-position: center; background-size: cover; background-attachment: fixed; "> 
        <div style="display: flex; align-items: center; justify-content: center; height: 100vh;">
            <div class = "cuadro" style="margin-left: auto; margin-right: auto; ">
                ...
                <a href="detalleperfil.php">
                    <input type="button" value="Detalles de perfil" style="; width: 200px; height: 50px; background-color: #350a06; color: white;"><br><br>
                </a>
                <a href="producto.html">
                <input type="button" value="Productos" style=" width: 200px; height: 50px; background-color: #350a06; color: white;"><br><br>
                </a>
                    
                <a href="facturapedidos.php">
                    <input type="button" value="Pedidos" style="width: 200px; height: 50px; background-color: #350a06; color: white;"><br><br>
                </a>
            
                <a href="historialcompra.php">
                    <input type="button" value="Cuenta" style=" width: 200px; height: 50px; background-color: #350a06; color: white;"><br><br>
